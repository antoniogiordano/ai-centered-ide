# AI-Centered IDE — Piano di sviluppo
...
- **Architecture profile**: `.aici/ARCHITECTURE.md` (intent + sparse overrides); stack is detected from the repo — vedi [architecture-profile.md](architecture-profile.md).
